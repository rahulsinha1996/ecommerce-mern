...
import { AiFillHeart, AiFillStar, AiOutlineEye, AiOutlineHeart, AiOutlineShopping, AiOutlineShoppingCart, AiOutlineStar } from 'react-icons/ai';
...
const ProductCard = ({ key, data }) => {
    ...
    return (
        <>
            <div key={key} className='w-full h-[370px] bg-white rounded-lg shadow-sm p-3 relative cursor-pointer'>
